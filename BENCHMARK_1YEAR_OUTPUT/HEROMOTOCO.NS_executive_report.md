...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 3865.01** | Rs. 4650.78 | **Rs. 3920.44** | Rs. 3539.36 |
| **Terminal Error (%)** | — | +20.33% (Exploded) | **+1.43%** | -8.43% |
| **Multi-Year MAE** | — | Rs. 508.74 | — | **Rs. 980.13** |
| **Multi-Year MAPE** | — | 10.55% | — | **20.35%** |
| **Scenario Envelope Coverage** | — | 0% | — | **19.9% of all trading days** |
...
* **Gross Potential Upside**: `-7.39%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**-7.64%**`
