...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 114.57** | Rs. 122.70 | **Rs. 858.93** | Rs. 595.90 |
| **Terminal Error (%)** | — | +7.10% (Exploded) | **+649.70%** | +420.12% |
| **Multi-Year MAE** | — | Rs. 6.59 | — | **Rs. 238.42** |
| **Multi-Year MAPE** | — | 5.15% | — | **188.57%** |
| **Scenario Envelope Coverage** | — | 0% | — | **6.1% of all trading days** |
...
* **Gross Potential Upside**: `+381.25%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**+381.00%**`
* **Objective Invalidation Stop-Loss**: `Rs. 346.81` (Downside: `-1.0%`)
* **Asymmetric Risk/Reward Ratio (RRR)**: `**381.0x**`
* **Half-Kelly Capital Allocation**: `39.0%`
* **Recommended Portfolio Exposure**: `**15.0%**` (Rs. 150,000.00 | **1050 shares**)
