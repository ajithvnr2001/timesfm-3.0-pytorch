...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 2304.00** | Rs. 2691.54 | **Rs. 2711.21** | Rs. 2430.57 |
| **Terminal Error (%)** | — | +16.82% (Exploded) | **+17.67%** | +5.49% |
| **Multi-Year MAE** | — | Rs. 439.28 | — | **Rs. 317.94** |
| **Multi-Year MAPE** | — | 19.06% | — | **13.76%** |
| **Scenario Envelope Coverage** | — | 0% | — | **69.6% of all trading days** |
...
* **Gross Potential Upside**: `-24.32%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**-24.57%**`
* **Objective Invalidation Stop-Loss**: `Rs. 1729.95` (Downside: `-44.0%`)
