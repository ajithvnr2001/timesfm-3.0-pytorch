...
* **Gross Potential Upside**: `+167.58%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**+167.33%**`
* **Objective Invalidation Stop-Loss**: `Rs. 97.71` (Downside: `-36.0%`)
* **Asymmetric Risk/Reward Ratio (RRR)**: `**4.64x**`
* **Half-Kelly Capital Allocation**: `34.9%`
