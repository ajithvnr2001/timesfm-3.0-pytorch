...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 114.57** | Rs. 177.79 | **Rs. 113.60** | Rs. 137.23 |
| **Terminal Error (%)** | — | +55.18% (Exploded) | **-0.84%** | +19.78% |
| **Multi-Year MAE** | — | Rs. 29.98 | — | **Rs. 10.40** |
| **Multi-Year MAPE** | — | 23.97% | — | **8.41%** |
| **Scenario Envelope Coverage** | — | 0% | — | **86.2% of all trading days** |
...
* **Gross Potential Upside**: `-50.49%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**-50.74%**`
