...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 886.95** | Rs. 1104.69 | **Rs. 667.16** | Rs. 837.89 |
| **Terminal Error (%)** | — | +24.55% (Exploded) | **-24.78%** | -5.53% |
| **Multi-Year MAE** | — | Rs. 126.72 | — | **Rs. 43.50** |
| **Multi-Year MAPE** | — | 14.80% | — | **4.92%** |
| **Scenario Envelope Coverage** | — | 0% | — | **44.3% of all trading days** |
...
* **Gross Potential Upside**: `-56.10%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**-56.35%**`
* **Objective Invalidation Stop-Loss**: `Rs. 272.22` (Downside: `-69.3%`)
