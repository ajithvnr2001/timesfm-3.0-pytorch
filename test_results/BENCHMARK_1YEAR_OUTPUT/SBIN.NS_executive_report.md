...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 765.50** | Rs. 757.05 | **Rs. 788.31** | Rs. 667.51 |
| **Terminal Error (%)** | — | -1.10% (Exploded) | **+2.98%** | -12.80% |
| **Multi-Year MAE** | — | Rs. 77.20 | — | **Rs. 122.94** |
| **Multi-Year MAPE** | — | 9.94% | — | **15.76%** |
...
* **Gross Potential Upside**: `+16.64%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**+16.39%**`
* **Objective Invalidation Stop-Loss**: `Rs. 460.23` (Downside: `-24.3%`)
* **Asymmetric Risk/Reward Ratio (RRR)**: `**0.67x**`
