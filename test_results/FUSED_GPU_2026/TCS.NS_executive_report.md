...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 2320.10** | Rs. 4118.81 | **Rs. 1674.82** | Rs. 2285.50 |
| **Terminal Error (%)** | — | +77.53% (Exploded) | **-27.81%** | -1.49% |
| **Multi-Year MAE** | — | Rs. 1192.81 | — | **Rs. 266.28** |
| **Multi-Year MAPE** | — | 51.71% | — | **11.48%** |
| **Scenario Envelope Coverage** | — | 0% | — | **77.6% of all trading days** |
...
* **Gross Potential Upside**: `-54.54%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**-54.79%**`
* **Objective Invalidation Stop-Loss**: `Rs. 1126.43` (Downside: `-63.5%`)
