...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 469.95** | Rs. 136.23 | **Rs. 136.23** | Rs. 136.23 |
| **Terminal Error (%)** | — | -71.01% (Exploded) | **-71.01%** | -71.01% |
| **Multi-Year MAE** | — | Rs. 89.28 | — | **Rs. 89.28** |
| **Multi-Year MAPE** | — | 29.89% | — | **29.89%** |
| **Scenario Envelope Coverage** | — | 0% | — | **34.1% of all trading days** |
...
* **Gross Potential Upside**: `+59.76%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**+59.51%**`
* **Objective Invalidation Stop-Loss**: `Rs. 97.71` (Downside: `-36.0%`)
* **Asymmetric Risk/Reward Ratio (RRR)**: `**1.65x**`
* **Half-Kelly Capital Allocation**: `10.8%`
* **Recommended Portfolio Exposure**: `**10.8%**` (Rs. 108,000.00 | **706 shares**)
* **Institutional Executive Directive**: `**ACCUMULATE / BUY (Favorable Risk/Reward)**`
