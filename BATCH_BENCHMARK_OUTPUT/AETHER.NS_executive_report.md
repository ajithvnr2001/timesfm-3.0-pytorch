...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 781.00** | Rs. 939.65 | **Rs. 567.23** | Rs. 516.67 |
| **Terminal Error (%)** | — | +20.31% (Exploded) | **-27.37%** | -33.84% |
| **Multi-Year MAE** | — | Rs. 61.28 | — | **Rs. 152.86** |
| **Multi-Year MAPE** | — | 7.39% | — | **18.19%** |
| **Scenario Envelope Coverage** | — | 0% | — | **36.7% of all trading days** |
...
| **Parametric 95% Horizon VaR** | **26.88%** | Cumulative 60-day volatility exposure |
| **Conditional VaR (CVaR / Expected Shortfall)** | **40.67%** | Average loss in worst 5% tail-risk scenarios |
