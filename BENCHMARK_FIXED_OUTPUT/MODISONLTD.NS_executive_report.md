...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 180.93** | Rs. 162.30 | **Rs. 115.85** | Rs. 132.04 |
| **Terminal Error (%)** | — | -10.30% (Exploded) | **-35.97%** | -27.03% |
| **Multi-Year MAE** | — | Rs. 14.40 | — | **Rs. 20.04** |
| **Multi-Year MAPE** | — | 10.99% | — | **13.43%** |
| **Scenario Envelope Coverage** | — | 0% | — | **47.6% of all trading days** |
...
* **Gross Potential Upside**: `-32.97%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**-33.22%**`
* **Objective Invalidation Stop-Loss**: `Rs. 62.19` (Downside: `-52.3%`)
