...
| :--- | :--- | :--- | :--- | :--- |
| **Terminal Price** | **Rs. 1787.29** | Rs. 1770.20 | **Rs. 1699.79** | Rs. 1642.69 |
| **Terminal Error (%)** | — | -0.96% (Exploded) | **-4.90%** | -8.09% |
| **Multi-Year MAE** | — | Rs. 105.91 | — | **Rs. 139.77** |
| **Multi-Year MAPE** | — | 6.95% | — | **8.64%** |
| **Scenario Envelope Coverage** | — | 0% | — | **79.3% of all trading days** |
...
* **Gross Potential Upside**: `+11.46%`
* **Indian Frictions Deducted (STT + SEBI + GST + Slippage)**: `-0.25%`
* **Net Horizon Upside**: `**+11.21%**`
* **Objective Invalidation Stop-Loss**: `Rs. 1074.73` (Downside: `-24.4%`)
* **Asymmetric Risk/Reward Ratio (RRR)**: `**0.46x**`
