...
![Portfolio PnL Distribution](portfolio_pnl_distribution.png)

### Chart 2: Action Matrix & Sector Capital Allocation
![Portfolio Action Matrix](portfolio_action_and_sector_matrix.png)

### Chart 3: 22-Day Forward Trajectories for Key Holdings Across Cohorts
![22-Day Forward Trajectories](portfolio_top_holdings_forecast_trajectories.png)

### Chart 4: Expected 1-Month Return Forecast (%) Across All 28 Stocks
![Expected 1-Month Return Forecast](portfolio_expected_returns_1m.png)
