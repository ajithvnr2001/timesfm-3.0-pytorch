...
| **5** | **No Semantic Reasoning Bridge**: Pure numerical forecasters cannot interpret qualitative disclosures. | **NVIDIA NIM LLM Reasoner**: Deploys `moonshotai/kimi-k3` & `meta/llama-3.2-11b-vision-instruct` to interpret guidance and synthesize mathematically verified scenario targets. | [`llm_reasoner.py`](llm_reasoner.py) |
